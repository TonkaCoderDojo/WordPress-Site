...
class backupbuddy_restore {
	...
	public function start( $backupFile, $skipUnzip = false ) {
		...
		if ( '' == $detectedDatLocation ) {
			return $this->_error( 'Unable to determine DAT file location. It may be missing. You can try manually unzipping then selecting the advanced option to skip unzip.' );
		}
